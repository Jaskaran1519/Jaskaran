...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex h-24 w-24 items-center justify-center rounded-full border-2 bg-white p-1 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export default function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex w-full max-w-[1200px]  items-center justify-center overflow-hidden rounded-lg  bg-background p-10 "
      ref={containerRef}
    >
      <div className="flex h-full w-full flex-col items-stretch justify-between gap-20">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref}>
            <Icons.googleDrive className="h-auto w-[10vw]" />
          </Circle>
          <Circle ref={div5Ref}>
            <Icons.googleDocs className="h-auto w-[20vw]" />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref}>
            <Icons.notion className="h-auto w-[10vw]" />
          </Circle>
          <Circle ref={div4Ref} className="h-32 w-32">
            <Icons.openai className="h-auto w-[10vw]" />
          </Circle>
          <Circle ref={div6Ref}>
            <Icons.zapier className="h-auto w-[10vw]" />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref}>
            <Icons.whatsapp className="h-auto w-[10vw]" />
          </Circle>
          <Circle ref={div7Ref}>
            <Icons.messenger className="h-auto w-[10vw]" />
          </Circle>
        </div>
      </div>
