...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[80vh] flex-col items-center justify-center overflow-hidden bg-black w-full z-0",
        className
      )}
    >
      ...
      <div className="relative z-50 flex -translate-y-60 xl:-translate-y-44 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
